...
var Search = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Search() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Search.__proto__ || Object.getPrototypeOf(Search)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["placeholder", "searchFn", "searchInput"], _this.config = {
  ...
  _createClass(Search, [{
    ...
    key: "searchContentInput",
    value: function searchContentInput(e) {
      var searchInput = this.props.searchInput;

      if (time) {
        clearTimeout(time);
        time = setTimeout(function (_) {
  ...
  return Search;
}(_taroWeapp.Component), _class.$$events = ["searchContent", "searchContentInput"], _class.$$componentPath = "components/Search/Search", _temp2);
