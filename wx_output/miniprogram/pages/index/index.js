...
var Index = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "loopArray9", "catalog", "barHeight", "bgUrl", "imgUrl", "dispatch"], _this.config = {
      ...
      dispatch({
        ...
        callback: function callback(res) {
          console.log(res);
          var arrayBuffer = new Uint8Array(res.buffer.data);
          var base64 = "data:image/png;base64," + _taroWeapp2.default.arrayBufferToBase64(arrayBuffer);
          console.log(base64);
          _this.setState({
            imgUrl: base64
          });
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      _taroWeapp2.default.cloud.downloadFile({
    ...
    value: function _createData() {
      ...
      var loopArray9 = catalog.map(function (item, __index0) {
        item = {
        ...
        var $loopState__temp4 = (0, _taroWeapp.internal_inline_style)({ whiteSpace: 'pre-line' });
        return {
